...
import { Rule, SectionHead, MobileFold } from "@/components/ui/primitives";
      ...
      <div className="gutter pb-4">
        <div className="shell glass p-[3px]">
          ...
          {/* --- specs + in the box + install --------------------------- */}
                    <MobileFold title="Specification">
  <section className="grid gap-10 py-12 lg:grid-cols-12">
              <div className="min-w-0 lg:col-span-7">
                <h2 className="text-[20px] font-bold">
                  Specification
          ...
          {/* --- compatibility ------------------------------------------ */}
                    <MobileFold title="Compatibility">
  <section className="grid gap-10 py-12 lg:grid-cols-12">
          ...
          {/* --- shipping & returns ------------------------------------- */}
                    <MobileFold title="Delivery & returns">
